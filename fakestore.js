...
function displayProduct(data){
    ...
    //console.log(products.filter(productPrice>200))
}
// const categoryFilter = document.getElementById('categoryFilter')

// categoryFilter.addEventListener("change",filterProducts)
// function filterProducts(){
//     const resultCategory =categoryFilter.value;
//     const filteredProducts =products.filter(function(val)
//     {
//         if (resultCategory !== 'all' && val.category !== resultCategory)
//         {
//             return false;
//         }
//         return true;
...
//     })
//     window.displayProduct(filteredProducts);
// }
